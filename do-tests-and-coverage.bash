...
##############################
#colcon build --cmake-args -DBUILD_TESTING=1 -DCMAKE_BUILD_TYPE=Debug
colcon build --cmake-args -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DBUILD_TESTING=1 -DCMAKE_BUILD_TYPE=Debug --symlink-install  --cmake-args -DCMAKE_CXX_FLAGS='-fprofile-arcs -ftest-coverage'  -DCMAKE_C_FLAGS='-fprofile-arcs -ftest-coverage'
set +u                          # stop checking undefined variable
...
##############################
colcon test-result --test-result-base build/anomaly_detection
...
colcon lcov-result --packages-select anomaly_detection
MY_CONTROLLER_COVERAGE_INFO=./build/anomaly_detection/coverage.info
...
## combine the reports
ALL_COVERAGE_INFO=./lcov/total_coverage.info
